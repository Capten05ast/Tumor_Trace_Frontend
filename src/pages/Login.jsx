...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-950 px-3 sm:px-4 py-8 sm:py-12 relative overflow-hidden">
            ...
            {/* ✅ PERFORMANCE: Absolute positioning + will-change for GPU acceleration */}
            <div className="absolute inset-0 overflow-hidden pointer-events-none -z-20">
                <motion.div
                    className="absolute -top-40 -left-40 w-[300px] h-[300px] sm:w-[600px] sm:h-[600px] bg-gradient-to-br from-teal-500/50 via-cyan-400/40 to-teal-500/50 rounded-full blur-3xl will-change-transform"
                    animate={{ scale: [1, 1.2, 1], opacity: [0.5, 0.7, 0.5] }}
                    transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
                />
                <motion.div
                    className="absolute -bottom-40 -right-40 w-[300px] h-[300px] sm:w-[600px] sm:h-[600px] bg-gradient-to-tl from-cyan-500/50 via-blue-500/40 to-transparent rounded-full blur-3xl will-change-transform"
                    animate={{ scale: [1.2, 1, 1.2], opacity: [0.7, 0.5, 0.7] }}
                    transition={{ duration: 8, repeat: Infinity, ease: "easeInOut", delay: 1 }}
                />
                <motion.div
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px] sm:w-[400px] sm:h-[400px] bg-gradient-to-br from-blue-500/40 via-teal-500/30 to-transparent rounded-full blur-3xl will-change-transform"
                    animate={{ rotate: [0, 360], scale: [1, 1.3, 1] }}
                    transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                />
            </div>

            {/* ✅ PERFORMANCE: Reduced particles (20 -> 10) */}
            ...
            {/* ✅ PERFORMANCE: Static grid (no animation) */}
            ...
            >
                <motion.div
                    className="absolute -inset-4 bg-gradient-to-r from-teal-500 via-cyan-500 to-blue-300 rounded-[3rem] opacity-40 blur-3xl will-change-transform"
                ...
                >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
                        ...
                        {/* Left Side - Branding (Shows on Desktop, Hidden on Mobile) */}
                        <div className="relative p-8 sm:p-12 lg:p-16 flex flex-col justify-center bg-gradient-to-br from-teal-500/10 to-cyan-500/10 border-b lg:border-b-0 lg:border-r border-slate-700">
                            ...
                            >
                                ...
                                {/* Heading - Beautiful Welcome Back */}
                            ...
                            >
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-6 sm:mb-6">
                                    ...
                                    <motion.button
                                        ...
                                        className="group relative py-4 sm:py-3 rounded-xl bg-slate-800 border border-slate-600 text-white font-semibold overflow-hidden backdrop-blur-sm hover:border-teal-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center"
                                    ...
                                    >
                                        ...
                                        <span className="relative flex items-center justify-center gap-2 text-lg sm:text-base font-bold text-white">
                                            {googleLoading ? (
                                    ...
                                    {/* GitHub Button - NOW PROPERLY CENTERED */}
                                    <motion.button
                                        type="button"
                                        onClick={() => window.open("https://github.com/capten05ast", "_blank")}
                                        className="group relative py-4 sm:py-3 rounded-xl bg-slate-800 border border-slate-600 text-white font-semibold overflow-hidden backdrop-blur-sm hover:border-cyan-500 flex items-center justify-center"
